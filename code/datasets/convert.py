...
class TT100KCOCOConverter:
    def __init__(self, image_dir, image_prefix="", txt_prefix=""):
    ...
    def init_coco_format_info(self):
        ...
        self.target_categories = [
            {"id": idx + 1, "name": x, "supercategory": x}
    ...
    def add_coco_img_dict(self, file_name, height=None, width=None):
    ...
    def add_coco_annotation_dict(self, img_txt, img_width, img_height):
        annotation_dicts = []
    ...
    def write_coco(self, label_path, json_indent=None):
        ...
        with open(label_path, mode="w") as f:
            ...
            json.dump(
                json.loads(
                    json.dumps(output_dict), parse_float=lambda x: round(float(x), 6)
                ),
                f,
                indent=json_indent,
                sort_keys=False,
...
def main():
    ...
    for dataset_type in ["image2"]:
        ...
        converter = TT100KCOCOConverter(
            image_dir, image_filename_prefix, txt_filename_prefix
        )
