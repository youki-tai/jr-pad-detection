...
def clean_data_by_distance(gt_anno, dt_anno, current_class, difficulty):
    ...
    for i in range(num_gt):
        ...
        if DISTANCE_COVER:
            if (
                (gt_anno["occluded"][i] > MAX_OCCLUSION[2])
...
def _prepare_data(gt_annos, dt_annos, current_class, difficulty, DIForDIS=True):
    ...
    for i in range(len(gt_annos)):
        rets = (
            clean_data(gt_annos[i], dt_annos[i], current_class, difficulty)
            if DIForDIS
            else clean_data_by_distance(
...
def eval_class(
    ...
    for m, current_class in enumerate(current_classes):
        for l, difficulty in enumerate(difficultys):
            rets = _prepare_data(
                gt_annos, dt_annos, current_class, difficulty, DIForDIS=DIForDIS
            )
            (
                gt_datas_list,
                dt_datas_list,
    ...
    for j, curcls in enumerate(current_classes):
        ...
        for i in range(min_overlaps.shape[0]):
            ...
            if i == 0:
                ...
                """
                ret_dict["%s_image_easy_R40" % class_to_name[curcls]] = mAPbbox_R40[
                    j, 0, 0
                ]
                ret_dict["%s_image_moderate_R40" % class_to_name[curcls]] = mAPbbox_R40[
                    j, 1, 0
                ]
                ret_dict["%s_image_hard_R40" % class_to_name[curcls]] = mAPbbox_R40[
                    j, 2, 0
                ]
    ...
    for j, curcls in enumerate(current_classes):
        ...
        for i in range(min_overlaps.shape[0]):
            ...
            if compute_aos:
                ...
                if i == 0:
                    ret_dict["%s_aos_30m_R40" % class_to_name[curcls]] = mAPaos_R40[
                        j, 0, 0
                    ]
                    ret_dict["%s_aos_50m_R40" % class_to_name[curcls]] = mAPaos_R40[
                        j, 1, 0
                    ]
                    ret_dict["%s_aos_70m_R40" % class_to_name[curcls]] = mAPaos_R40[
                        j, 2, 0
                    ]
            ...
            if i == 0:
                ...
                ret_dict["%s_image_30m_R40" % class_to_name[curcls]] = mAPbbox_R40[
                    j, 0, 0
                ]
                ret_dict["%s_image_50m_R40" % class_to_name[curcls]] = mAPbbox_R40[
                    j, 1, 0
                ]
                ret_dict["%s_image_70m_R40" % class_to_name[curcls]] = mAPbbox_R40[
                    j, 2, 0
                ]
